  ...
  <div class="chat-container">
    ...
    <div class="chat-header">
      <div class="header-content">
        ...
        <h1>航空货运无人机智能专家</h1>
        <div class="chat-info">
          <span class="chat-id">聊天 ID: {{ chatId }}</span>
        </div>
      </div>
    </div>
...
import { chatWithUavAppSSE } from '../services/api.js'
...
export default {
  ...
  methods: {
    ...
    getAIResponse(message) {
      try {
        // Create EventSource
        this.eventSource = chatWithUavAppSSE(message, this.chatId)
        ...
        this.eventSource.onmessage = (event) => {
          ...
          try {
            ...
            const chunk = parsed.content || parsed.message || ''
